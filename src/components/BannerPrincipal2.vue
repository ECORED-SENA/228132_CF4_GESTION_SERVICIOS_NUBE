      ...
      .col-lg-7.col-xxl-6.py-4.py-sm-5.banner-principal__info.ps-5
        ...
        .col-lg-12
          .banner-principal__descripcion
            p.mb-0(v-html="globalData.descripcionCurso" style="color: black")
        .banner-principal__accion
          router-link.boton(:to="{name: iniciarLnk.nombreRuta }" style="background-color: #F59D36")
            span.me-1 Iniciar
            i.fas.fa-angle-right

      .d-none.d-lg-flex.col-lg-5.px-0.position-relative.img-p.align-items-center.img-banner-1
        img(:src="globalData.imagenBannerPrincipal").my-auto
